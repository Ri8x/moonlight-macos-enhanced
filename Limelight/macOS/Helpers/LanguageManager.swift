...
public class LanguageManager: NSObject, ObservableObject {
  ...
  private let zhHans: [String: String] = [
    ...
    // Simplified Chinese for the keys introduced by the English coverage pass.
    "%d Selected": "已选 %d 项",
    "Add address (IP, hostname, or IPv6; port optional)": "添加地址（IP/域名/IPv6，可含端口）",
    "Address": "地址",
    "Administrator authorization did not complete. Confirm that this account has administrator privileges and try again.":
      "管理员授权没有完成，请确认当前账户有管理员权限后重试。",
    "Administrator authorization timed out. Please try again.": "管理员授权超时，请重试。",
    "Administrator authorization was cancelled.": "你已取消管理员授权。",
    "All": "全部",
    "All Levels": "全部级别",
    "Apply": "应用",
    "Automatically Selected: %@": "自动选择：%@",
    "Changing the address will replace the current connection method.": "修改地址后会替换当前连接方式",
    "Clear Category Filters": "清空分类筛选",
    "Connection Error": "连接异常",
    "Connection Failed": "连接失败",
    "Connection Methods - %@": "连接方式 - %@",
    "Copied": "已复制",
    "Copy Curated Log": "复制默认日志",
    "Copy Log": "复制日志",
    "Copy Raw Log": "复制原始日志",
    "Curated View": "默认视图",
    "Current": "当前",
    "Current (Custom): %dx%d": "当前 (自定义): %dx%d",
    "Current Connection Method": "本次连接方式",
    "Current: %d FPS": "当前: %d FPS",
    "Custom Frame Rate": "自定义帧率",
    "Custom Resolution and Frame Rate": "自定义分辨率与帧率",
    "Custom…": "自定义…",
    "Debug": "调试",
    "Default Connection Method": "默认连接方式",
    "Display": "屏幕",
    "Display Mode": "显示模式",
    "Edit Connection Methods": "编辑连接方式",
    "Enable Scrolling": "开启滚动",
    "Enter the desired frame rate (FPS).": "请输入期望的帧率（FPS）。",
    "Enter the resolution (width x height) and frame rate (FPS).\nA value of 0 lets the host decide and is not recommended.":
      "请输入期望的分辨率（宽 x 高）和帧率（FPS）。\n设置为 0 代表由服务端决定（不建议）。",
    "Error": "错误",
    "Exit Stream": "退出串流",
    "Height:": "高:",
    "High Packet Loss": "高丢包",
    "Host Startup Is Taking Longer": "主机启动较慢",
    "Host Status: %@": "主机状态：%@",
    "Info": "信息",
    "Internet": "外网",
    "Keep Waiting": "继续等待",
    ...
    "Logs": "日志",
    "Logs copied": "日志已复制",
    "Match Display (%.0fx%.0f)": "跟随显示器 (%.0fx%.0f)",
    "More": "更多",
    "No Addresses Available": "无可用地址",
    "No Default (Automatic)": "不设默认（自动）",
    "No Filter": "未筛选",
    "No Filter (Showing All)": "未筛选（显示全部）",
    "No Filter Applied": "当前未筛选（显示全部）",
    "No administrator authorization response was received. Please try again.": "没有收到管理员授权结果，请重试。",
    "No administrator authorization response was received. This build's security restrictions may be blocking the system authorization dialog.":
      "没有收到管理员授权结果。当前这个构建的安全限制可能拦住了系统授权窗。",
    "No video data has arrived for 15 seconds.\nCheck your network connection or try one of the following options.":
      "已持续 15 秒未接收到视频数据。\n请检查网络连接或尝试以下操作。",
    "Online (%dms)": "在线 (%dms)",
    "Parsed Message": "解析消息",
    "Pause Scrolling": "暂停滚动",
    "Pause Updates": "暂停更新",
    "Paused, %lu entries pending": "暂停中，待处理 %lu 条",
    "Quality": "画质",
    "Raw Line": "原始行",
    "Recommended Profile": "推荐档位",
    "Reconnect": "重连",
    "Reconnect Timed Out": "重连超时",
    "Reconnecting took too long and the connection may have been lost.\nCheck your network or adjust the stream settings.":
      "重连过程耗时过长，连接可能已断开。\n请检查网络环境或调整设置。",
    "Reconnecting…": "重连中…",
    "Reconnecting… (%ld)": "重连中…（%ld）",
    "Remove": "删除",
    "Resume Updates": "继续更新",
    "Search terms / host / error code": "搜索关键词 / 主机 / 错误码",
    "Search terms / host / error code / category": "搜索关键词 / 主机 / 错误码 / 分类",
    "Search=%@": "搜索=%@",
    "Show Fullscreen Control Ball": "全屏显示悬浮球",
    "Show Logs": "显示日志",
    "Showing %lu rows / %lu source entries": "显示 %lu 行 / 原始 %lu 条",
    "Showing 0 rows": "显示 0 行",
    "Source": "来源",
    "Stalled %lus": "卡住%lus",
    "Test All": "测速全部",
    "The host is still starting or resuming the stream. This can take much longer than video startup.\nYou can keep waiting, reconnect manually, or go back and try again.":
      "主机仍在启动或恢复串流，会比视频阶段慢很多。\n可继续等待，或手动重连 / 返回后重新进入。",
    "The network is not responding. Trying to reconnect…": "网络无响应，正在尝试重连…",
    "The system authorization dialog did not appear. This build's security restrictions may be blocking the request.":
      "系统没有正常弹出管理员授权窗口。当前这个构建的安全限制可能拦住了这类请求。",
    "The system blocked the administrator authorization request.": "系统拦截了管理员授权请求。",
    "Try Reconnecting": "尝试重连",
    "Unknown Error": "未知错误",
    "Unstable Connection or No Video": "连接不稳定或无画面",
    "Warn": "警告",
    "Width:": "宽:",
